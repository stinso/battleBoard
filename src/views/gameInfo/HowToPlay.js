  ...
  return (
    <Paper className={classes.paper}>
      ...
      <Typography className={classes.typo} color="textPrimary" variant="body1">
        ...
        gaming networks. You must maintain sufficient Chain Network balance and
        have it approved 30 minutes before the event starts.
      </Typography>
      <Typography className={classes.typo} color="textPrimary" variant="body1">
        - Once the event starts, join a Warzone match and try to score as many
        kills as you can.
      </Typography>
      <Typography className={classes.typo} color="textPrimary" variant="body1">
      ...
      <Typography className={classes.typo} color="textPrimary" variant="body1">
        - Results are declared soon after the event ends and can be seen in your
        event history.
      </Typography>
    </Paper>
  );
