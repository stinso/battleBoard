          ...
          >
            ...
            <Box mt={2}>
              <Typography
                ...
                color="textSecondary"
              >
                Before proceeding with the withdrawal we want to confirm that the following conditions are met:
              </Typography>
            </Box>
            <Box mt={2}>
              <Paper
              ...
              >
                ...
                <Box ml={2}>
                  <Typography
                    ...
                    color="textPrimary"
                  >
                    Reward Accumulated {acc.loggedIn ? ethers.utils.formatEther(rewardAmount.toString()) : '0'} CHAIN
                  </Typography>
                  <Typography
                    variant="body1"
                    color="textPrimary"
